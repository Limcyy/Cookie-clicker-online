...
function add() {
  value++
  document.querySelector('#fifthscore').innerHTML = value
}

async function moreCookies() {
  await patchData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json", { versus5: value })
  moreCookies()
}
