...
patchData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json", {versus5:1}).then((data) => {
        console.log(data); 
...
function add() {
    console.log("hoj")
value++
    patchData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json", {versus5:value}).then((data) => {
        console.log(data); 
...
getData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json").then((data) => {
    ...
    document.querySelector('#nenescore').innerHTML = data.versus3
