...
function add() {
  value++
  document.querySelector('#secondscore').innerHTML = value
}

async function moreCookies() {
  await patchData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json", { versus2: value })
  moreCookies()
}
