...
patchData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json", { versus3: value }).then((data) => {

});

function add() {
  value++
  document.querySelector('#thirdscore').innerHTML = value
}

async function moreCookies() {
  await patchData("https://awesomeapp-f2b19-default-rtdb.asia-southeast1.firebasedatabase.app/.json", { versus3: value })
  moreCookies()
}
